# Generated by Django 4.2 on 2023-05-31 13:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delimiter', models.CharField(choices=[(',', 'Comma (,)'), (';', 'Semicolon (;)'), ('\t', 'Tab (\t)'), (' ', 'Space ( )'), ('|', 'Vertical bar (|)')], default=',', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='data_sets', to='fakecsv.schema')),
            ],
        ),
        migrations.CreateModel(
            name='Column',
            fields=[
                ...
                ('schema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='columns', to='fakecsv.schema')),
            ],
        ),
    ]
